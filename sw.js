...
const CACHE_NAME = 'v1_cache_fluotec',
  urlsToCache = [
    './',
    './index.min.html',
    './html/vegalux-300.min.html',
    './html/auralux.min.html',
    './html/awards.min.html',
    './html/cine-light.min.html',
    './html/conquering.min.html',
    './html/star-maker.min.html',
    './html/studio-led.min.html',
    './css/style.min.css',
    './css/styles-products.min.css',
    './css/awards.min.css',
    './script.js',
    './img/g6led-177-1.png',
    './img/g6led-171-2.png',
